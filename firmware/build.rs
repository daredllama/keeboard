...
fn generate_vial_config() {
    ...
    XzEncoder::new(vial_cfg.as_bytes(), 6)
        ...
        .unwrap();
    // Randomly generated 8-byte ID unique to this board, used by Vial to
    // distinguish it from other keyboard definitions.
    let keyboard_id: Vec<u8> = vec![0x42, 0xCE, 0x40, 0x79, 0xB4, 0x04, 0xED, 0x01];
